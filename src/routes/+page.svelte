			...
			<nav class="flex h-9 items-center justify-between" aria-label="Global">
				<div class="flex lg:min-w-0 lg:flex-1" aria-label="Global">
					<a href="#" class="-m-1.5 p-1.5">
						...
						<img class="h-8" src="/logo_128.png" alt="" />
					</a>
				</div>
				...
				<div class="hidden lg:flex lg:min-w-0 lg:flex-1 lg:justify-center lg:gap-x-12">
					{#each navigation as item}
						<a href={item.href} class="font-semibold text-gray-900 hover:text-gray-900"
							>{item.name}</a>
					{/each}
				</div>
				...
				<div>
					...
					<div>
						<h1 class="text-4xl font-bold tracking-tight sm:text-center sm:text-6xl">
							Empowering collaborative knowledge
						</h1>
						<p class="mt-6 text-lg leading-8 text-gray-600 sm:text-center">
							WikiChain is a decentralized encyclopedia built on the blockchain. With WikiChain,
							anyone can contribute and access knowledge, free from censorship and central control.
						</p>
